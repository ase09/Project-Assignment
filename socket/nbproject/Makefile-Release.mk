...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/libsocket.so

dist/Release/GNU-Linux-x86/libsocket.so: ${OBJECTFILES}
...
${OBJECTDIR}/_ext/rcapl/workspace/sanath/socket/ServerSocket.o: nbproject/Makefile-${CND_CONF}.mk /rcapl/workspace/sanath/socket/ServerSocket.cc 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/rcapl/workspace/sanath/socket/ServerSocket.o /rcapl/workspace/sanath/socket/ServerSocket.cc
...
${OBJECTDIR}/_ext/rcapl/workspace/sanath/socket/Socket.o: nbproject/Makefile-${CND_CONF}.mk /rcapl/workspace/sanath/socket/Socket.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/rcapl/workspace/sanath/socket
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/rcapl/workspace/sanath/socket/Socket.o /rcapl/workspace/sanath/socket/Socket.cc

${OBJECTDIR}/ClientSocket.o: nbproject/Makefile-${CND_CONF}.mk ClientSocket.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/ClientSocket.o ClientSocket.cc
...
.clean-conf:
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/libsocket.so
